...
export const emailCheck = async (email) => {
    return (await request.post(apiRoutes.auth.emailCheck, email));
};

export const forgotPassword = async (email) => {
    return (await request.post(apiRoutes.auth.forgotPassword, {email}));
};

export const resetPassword = async (data) => {
    return (await request.post(apiRoutes.auth.resetPassword, data));
}
